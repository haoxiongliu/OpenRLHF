...
if __name__ == "__main__":
    ...
    parser.add_argument("--ratio_type", type=str, default="sum", choices=["single", "sum", "average"], help="ratio type for PLMO")
    parser.add_argument("--policy_loss_type", type=str, default="ppo", choices=["ppo", "plmo", "gspo"])
